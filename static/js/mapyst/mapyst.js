...
function mapyst_campus(callback) {
	...
	return $.getJSON("http://www.mapyst.com/api/campus.php", params, callback)
}
...
function mapyst_blueprint_url(building, floor) {
	return "http://www.mapyst.com/api/blueprint.php?building=" + building + "&floor=" + floor + "&api_key=" + API_KEY;
}
...
function mapyst_blueprint(building, floor, callback) {
	...
	$.getJSON("http://www.mapyst.com/api/blueprint.php", params, callback);
}
...
function mapyst_route(start, end, search, prefs, callback) {
	...
	$.getJSON("http://www.mapyst.com/api/route.php", params, callback);
}
